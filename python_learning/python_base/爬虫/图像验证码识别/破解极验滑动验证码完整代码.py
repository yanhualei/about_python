...
class HuXiu(object):
    def __init__(self):
        chrome_option = webdriver.ChromeOptions()  # ChromeOptions:设置窗口属性
        chrome_option.set_headless(headless=True)  # 设置为无头浏览器，也就是程序运行不再弹出窗口

        self.driver = webdriver.Chrome(executable_path=r"/usr/bin/chromedriver", chrome_options=chrome_option)
        self.driver.set_window_size(1440,900)  # 设置当前窗口的大小，没发现有什么卵用
    ...
    def visit_index(self):
        ...
        reg_element.click()  # 点击一下滑动按钮，让验证图片产生缺块
